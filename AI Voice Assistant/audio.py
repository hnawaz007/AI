...
# Settings
# ----------------------------
MODEL_PATH = "vosk-model-small-en-us-0.15"  # Path to vosk model folder (downloaded + unzipped)
WAKE_WORD = "hey amy"
...
def listen_for_wake_word():
    ...
    with sd.RawInputStream(samplerate=RATE, blocksize=8000, dtype='int16', channels=1, callback=audio_callback):
        print("Listening for wake word... Say 'hey amy'")
...
if __name__ == "__main__":
    while True:
        if listen_for_wake_word():   # Wait for "hey Amy"
